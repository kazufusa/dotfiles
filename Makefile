...
install:
	...
	" --with-features=huge --enable-gui=gtk7 --enable-perlinterp --enable-pythoninterp --enable-python3interp --enable-rubyinterp --enable-luainterp --enable-fail-if-missing"
