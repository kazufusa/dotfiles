...
sudo apt-get install -y gettext libncurses5-dev libacl1-dev libgpm-dev libxmu-dev libgtk2.0-dev libxpm-dev libncurses5-dev libperl-dev  python3-dev ruby-dev lua5.2 liblua5.2-dev exuberant-ctags
